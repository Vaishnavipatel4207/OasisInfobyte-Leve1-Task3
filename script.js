...
function converter() {
  ...
  // Celcius to farenheit
    ...
    inputSelect.selectedOptions[0].value === 'Celsius' &&
    resultSelect.selectedOptions[0].value === 'Fahrenheit'
  ) {
  ...
  // farenheit to celcius
    ...
    inputSelect.selectedOptions[0].value === 'Fahrenheit' &&
    resultSelect.selectedOptions[0].value === 'Celsius'
  ) {
    result.value =
